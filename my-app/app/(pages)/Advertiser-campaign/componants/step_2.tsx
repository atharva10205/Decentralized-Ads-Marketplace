...
export default function Two({ adID, next, back }: StepProps) {
    ...
    useEffect(() => {
        ...
        return () => {
            isMounted = false;
            setTimeout(() => {
                if (!isMounted && !completedRef.current && adIDRef.current) {
                    ...
                    <div className="flex-1">
                        <div className="bg-[#111111] border border-gray-800/70 rounded-xl overflow-hidden">
                            ...
                            <div className="px-4 sm:px-8 py-4 sm:py-5 bg-[#0d0d0d] border-t border-gray-800/60 flex items-center justify-between gap-3">
                                ...
                                <button
                                    onClick={Next_btn}
                                    className="flex-1 sm:flex-none px-6 py-2.5 cursor-pointer rounded-lg bg-[#161616] text-gray-200 text-sm font-semibold hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200"
