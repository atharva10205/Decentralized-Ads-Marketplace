...
import {  Copy,  User, RefreshCw, Target, TrendingUp,Bell, Shield, Wallet } from 'lucide-react';
                            ...
                            <div className="p-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <button
                                        ...
                                        className={`group relative p-6 rounded-xl border-2 transition-all duration-300 ${currentRole === 'advertiser'
                                    ...
                                    >
                                        ...
                                        <div className="flex items-start gap-4">
                                            <div className={`p-3 rounded-xl transition-all duration-300 ${currentRole === 'advertiser'
                                    ...
                                    <button
                                        ...
                                        disabled={isSwitching}
                                        className={`group relative p-6 rounded-xl border-2 transition-all duration-300 ${currentRole === 'publisher'
                                    ...
                                    >
                                        ...
                                        <div className="flex items-start gap-4">
                                            <div className={`p-3 rounded-xl transition-all duration-300 ${currentRole === 'publisher'
